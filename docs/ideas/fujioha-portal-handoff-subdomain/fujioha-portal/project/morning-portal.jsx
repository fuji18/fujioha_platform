...
function SiteCard({ subdomain, href, jp, en, tagline, taglineEn, stats, accent, cta, ctaEn, tone }) {
  return (
    <a className={`fp-site fp-site-${tone}`} href={href} style={{ '--card-accent': accent }}>
